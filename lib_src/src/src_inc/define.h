...
//终端交易数据状态定义
#define DC_HAVE_UP				"00"	//平台上传成功
#define DC_NOT_UP				"01"	//平台未上传(需要上送)
...
//交易结果
#define RESULT_OK  "00"				//交易成功
#define REDULT_GREY_LOCK "01"		//灰锁交易
...
#define ERR_DATA_STORE		0x0239   	 	// 交易存储失败
#define ERR_NOT_FIND_DATA		0x0240   	 // 交易未发现
